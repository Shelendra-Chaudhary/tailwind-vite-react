...
export default function Register() {
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="w-full p-6 bg-gray-800 rounded-lg shadow-lg text-white py-10">
        ...
        <label for="email" className="block text-sm font-medium mb-2 text-left">
            Email
        </label>
        <input
          type="email"
        ...
        <Link to="/login" className="block text-center mt-4 text-sm text-gray-400 hover:text-gray-200">
